...
`;
    ...
    function initSettingBox() {
        ...
        dom += `<label class=" chooseRegionsBlock" style="text-align:left;display:`+(no_need_VPN_play==1?'block':'none')+`"><div   style="display: inline;">IP Giả mạo：</div>`;
        ...
        dom += `<input type='text' style="display: `+(useCustomfakeIp==1?'inline':'none')+`;outline: none;width: 125px;" id="customfakeIpInput" class="customfakeIpListener" value="${customfakeIp}" placeholder="nhập IP Tuỳ Chỉnh"/>`
        dom += `</div>`
        dom+=`</label><hr style="background-color: black;width:95%" />`;
        ...
        dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Tắt các cảnh báo mạng：</div>`;
        ...
        dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Tự động bật Classic Control：</div>`;
        ...
        dom+=`<div style="text-align: right;margin-top: 8px;font-size: 16px;"><lable>Việt Hoá By Nguyễn Văn Đoàn & Kênh：</lable><a style="margin-right:15px;outline: none;color: #107c10;text-decoration: underline;" href="https://greasyfork.org/rails/active_storage/blobs/redirect/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBMVNFQVE9PSIsImV4cCI6bnVsbCwicHVyIjoiYmxvYl9pZCJ9fQ==--14c278e3f72d104cff50bf130d4039229fc25a6b/wx.png?locale=zh-CN">Xbox Cloud Việt Nam</a><a style="outline: none;color: #107c10;text-decoration: underline;" https://raw.githubusercontent.com/Doann7457/7457/main/PNG/wechat.png?locale=zh-CN">Wechat</a></div>`
