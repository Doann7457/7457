// ==UserScript==
// @name                 Tích hợp tối ưu hóa Xbox Cloud Gaming Nút nổi v1 Viethoa
...
(function () {
    ...
    let default_language_list = {'Thông minh': 'Auto', 'giản thể': 'zh-CN', 'truyền thống': 'zh-TW'}
...
`;
        ...
        dom += `<label class=" IfErrUsedefaultGameLanguageBlock" style="display:` + (xcloud_game_language == 'Auto' ? 'block' : 'none') + `;text-align:left;"><div   style="display: inline;">Sử dụng khi lỗi：</div>`;
        ...
        dom += `<input type="radio" class="regionSingleListener settingsBoxInputRadio" style="outline:none;" name='selectRegion' id="customfakeIp" value="customfakeIp" ${useCustomfakeIp == 1 ? 'checked' : ''}><label for="customfakeIp" style="padding-right: 15px;">Tuỳ chỉnh IP：</label>`;
